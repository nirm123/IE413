...
Name:             INIT
Description:      
State Changes:    SERVER[0]=2,SERVER[1]=2,QUEUE[0]=0,QUEUE[1]=0,ID[0]=-1,ID[1]=0,ID[2]=0,ID[3]=0,ID[4]=0,ID[5]=0,ID[6]=0,ID[7]=0,RATIO[0]=0,RATIO[1]=0,RATIO[2]=0,ID[9]=0
Parameter(s):     
Bitmap(Inactive): 
Bitmap(Active):   
...
State Changes:    ID[0]=ID[0]+1,QUEUE[0]=QUEUE[0]+1,SYSTEM[ID[0]]=CLK,RATIO[1]=RATIO[1]+CLK*(QUEUE[0]==8&RATIO[2]==0),RATIO[2]=(QUEUE[0]>7)
Parameter(s):     
Bitmap(Inactive): 
Bitmap(Active):   
Use Flowchart Shapes:   0
Use Opaque Bitmaps:   0
Location:         X: -0.90;  Y:  1.88;  Z: -1.00;
Local Trace:      
Trace Location:   Bottom
...
State Changes:    QUEUE[0]=QUEUE[0]-1,SERVER[0]=SERVER[0]-1,ID[2]=ID[2]+1,SERVICE[ID[1]]=CLK,RATIO[0]=RATIO[0]+(CLK-RATIO[1])*(QUEUE[0]==7),RATIO[1]=RATIO[1]*(QUEUE[0]!=7),RATIO[2]=(RATIO[1]!=0)
Parameter(s):     ID[1]
Bitmap(Inactive): 
Bitmap(Active):   
Use Flowchart Shapes:   0
Use Opaque Bitmaps:   0
Location:         X: -0.21;  Y:  1.89;  Z: -1.00;
Local Trace:      
Trace Location:   Bottom
